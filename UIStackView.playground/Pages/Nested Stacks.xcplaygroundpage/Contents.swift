...
if #available(iOS 9, *) {
    ...
    var stackViewColumn1 = UIStackView(frame: CGRectMake(0, 0, stackViewContainer.frame.size.width/2, 500))
    stackViewColumn1.axis = .Vertical
    stackViewColumn1.distribution = .FillEqually
    
    var view1 = UIView(frame: CGRectMake(0, 0, stackViewContainer.frame.size.width/2, 500/2))
    view1.backgroundColor = .greenColor()
    var view2 = UIView(frame: CGRectMake(0, 0, stackViewContainer.frame.size.width/2, 500/2))
    view2.backgroundColor = .yellowColor()
    
    stackViewColumn1.addArrangedSubview(view1)
    stackViewColumn1.addArrangedSubview(view2)
    
    var stackViewColumn2 = UIStackView(frame: CGRectMake(0, 0, stackViewContainer.frame.size.width/2, 500))
    stackViewColumn2.axis = .Vertical
    stackViewColumn2.distribution = .FillEqually
    
    var view3 = UIView(frame: CGRectMake(0, 0, stackViewContainer.frame.size.width/2, 500/2))
    view3.backgroundColor = .whiteColor()
    var view4 = UIView(frame: CGRectMake(0, 0, stackViewContainer.frame.size.width/2, 500/2))
